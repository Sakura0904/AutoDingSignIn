        ...
        <vertical padding="25">
            ...
            <vertical>
                <horizontal>
                    ...
                    <input id="timeMorningHour" padding="10" gravity="center" text="07" inputType="number"/>
                    <text text=":"/>
...
function Unlock_Screen() {
    ...
    var i=0; 
    for(i=0;i<=userUi.keynum;i++){
        desc(phoneKey[i]).findOne().click();
        log("Procedure：已输入密码："+phoneKey[i]);
    }
    sleep(2000);//密码输入
    home();
    sleep(1000);//回到手机主页
