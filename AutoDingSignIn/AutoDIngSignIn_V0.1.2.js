...
ui.layout(
    <scroll>
        <vertical padding="25">
            ...
            <text gravity="right" textSize="10sp" textColor="black" textStyle="bold"> 版本：V0.1.2</text>
            <vertical>
                <text textColor="white" textSize="15sp" bg="#00ccff"  text="提示: "/>
            ...
            <text textColor="black" textSize="15sp"  bg="#00ccff" text="任务时间："/>
            <vertical>
                ...
                <text textColor="black" textSize="15sp"  bg="#00ccff" text="开机密码："/>
                <text textColor="black" text="用于自动解锁您的手机"/>
            <horizontal>
                <radiogroup>
            ...
            <horizontal gravity="center" bg="#ffc0cd">
                <input id="phoneKey1" padding="5" gravity="center" inputType="numberPassword"/>
                <input id="phoneKey2" padding="5" gravity="center" inputType="numberPassword"/>
                <input id="phoneKey3" padding="5" gravity="center" inputType="numberPassword"/>
                <input id="phoneKey4" padding="5" gravity="center" inputType="numberPassword"/>
                <input id="phoneKey5" padding="5" gravity="center" inputType="numberPassword"/>
                <input id="phoneKey6" padding="5" gravity="center" inputType="numberPassword"/>
            </horizontal>
            ...
            <horizontal>
                ...
                <button id="userButtonTest" w="*"   text="测试   (点击后手动请息屏)"/>
            </horizontal>
...
ui.userBi.click(function(){
    ...
    app.openUrl("https://space.bilibili.com/18175274");
});
