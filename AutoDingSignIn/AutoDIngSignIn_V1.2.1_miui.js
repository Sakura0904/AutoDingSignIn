...
ui.layout(
    <scroll bg="#FFE7BA">
        <vertical padding="25">
            ...
            <text gravity="right" textSize="10sp" textColor="black" textStyle="bold"> 版本：V1.2.1_MIUI</text>
            <vertical>
            ...
            <button     id="userButtonStart" w="*"   h="60" bg="#ffc0cd" text="启动定时打卡程序"/>
            ...
            <vertical>
                <button id="userUpDate" w="*" bg="#FFE1FF"  text="'蒲公英'更新"/>
                <button id="userGitHub" w="*" bg="#000000"  text="GitHub开源"/>
                <text text=""/>
                <text text="若您觉得本软件使用方便，不妨点击上方“打赏”按钮，"/>
                <text text="(づ￣3￣)づ╭❤～给这个快吃不起饭的Up打点赏钱"/>
                <text text=""/>
                <img src="https://i2.hdslb.com/bfs/face/d3980a444270007643d11a7f950ee004ccd33df3.jpg@128w_128h_1o.webp"/>
